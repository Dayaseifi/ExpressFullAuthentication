...
async function CheckUserByDecodedToken(Email, Id) {
    return new Promise((resolve, reject) => {
        const sql = `SELECT * FROM user WHERE Email = ? AND Id = ?`;
...
module.exports = {generateResetToken, updateRefreshToken , IsUserExistByEmail, RefreshTokenComparer, generateRefreshToken, ClearRefreshAtDB, CheckUserByDecodedToken, Logout, SetImageByUserID, UserCreate, GetUserByID, Loggin, GetUserByEmail, GetUserByRefreshToken, generateAccessToken };
